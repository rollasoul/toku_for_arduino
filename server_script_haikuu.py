...
p = Popen(['/root/rnnlib/rnnsynth --sampleBias=2.0 --primeID=1 synth1d@2016.08.20-04.20.35.004518.best_loss.save > lines.txt'], shell=True, stdout=PIPE, stdin=PIPE, stderr=PIPE)
